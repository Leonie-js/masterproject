...
<body id="module">
	...
	<div class="instructions">
		<h1>Instructions</h1>
		<p> Text explaining code and stuff</p>
	</div>
	<div class="example">
		<p> Text about what you can do with example</p>
		<p> In this example you can write something in the page where the id box is </p>

		<code class="ex">document.vindElementMetId("box").inHTML = "<input id="ex1" type="text">";</code>
