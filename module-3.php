...
<body id="module">
	...
	<div class="instructions">
		...
		<pre class="ex"><span class="keyword">document</span>.<span class="property">getElementById</span>();</pre><br/>
	...
	text <span class="operator">=</span> result;
}</code></pre><br/>

	</div>

	<div class="example">
		<p>Try running the function with different argument.</p>
	...
	<div class="example">
		...
		<pre style="width: 500px;" ><code style="padding:initial;"><span class="keyword">var</span> dateobject <span class="operator">=</span> <span class="operator">new</span> Date();
<span class="keyword">var</span> dateformat <span class="operator">=</span> dateobject.<input id="3-1-1" type="text" data-answer="getDay()"> <span class="operator">+</span> <span class="string">'-'</span> <span class="operator">+</span> dataobject.<input id="3-1-2" type="text" data-answer="getMonth()"> <span class="operator">+</span> <span class="string">'-'</span> <span class="operator">+</span> dataobject.<input id="3-1-3" type="text" data-answer="getFullYear()">;</pre></code><br/>
	...
	<?php echo "<a href='/exercise-2?userID=".$userID."&language=".$language."'>Go to excercise of Module 2</a>"?>
	...
	?>
		...
		<p>Er kunnen ook andere functies gebruikt worden die geen () achter zich hebben staan. Een voorbeeld hiervan is 'inHTML'. Dit kan met een punt achter de vindElementMetId worden gezet of achter een variable die daarvan is gemaakt om de HTML van dit element te veranderen. Dit is de tekst wat wordt laten zien in een webbrowser.</p>
		...
		<p>Je kunt je eigen functies kan definiëren — in het volgende voorbeeld schrijven we een eenvoudige functie die twee nummers als argumenten krijgt en die de twee nummers vermenigvuldigt:</p>
	...
	tekst <span class="operator">=</span> result;
}</code></pre><br/>

		<p>Om je functie uit te voeren kun dit doen:</p>
		<pre class="ex"> mijnFunctie();</pre><br/>
	...
	<div class="instructions">
		...
		<pre class="ex"> gebruikInterval(mijnFunctie, <span class="number">1000</span>);</pre><br/>
		...
		<p>De operator 'nieuwe' wordt gebruikt om een nieuwe Date object te maken. The operator 'new' is used to make a new Date object. Een JavaScript Datum creeert een instantie die een enkel punt in tijd voorstelt. Date objecten zijn gebaseerd op een tijdwaarde die gelijk staat aan het aantal milliseconden sinds 1 Januari, 1970 UTC. Een voorbeeld van welke informatie je terug krijgt staat hieronder. Door de pagina te refreshen kun je de seconden voorbij zien tikken.</p>
	...
	<div class="example">
		...
		<pre style="width: 500px;" ><code style="padding:initial;"><span class="keyword">var</span> datum <span class="operator">=</span> <span class="operator">nieuwe</span> Datum();
<span class="keyword">var</span> datumformaat <span class="operator">=</span> <input id="3-1-1" type="text" data-answer="verkrijgDag()"> <span class="operator">+</span> <span class="string">'-'</span> <span class="operator">+</span> datum.<input id="3-1-2" type="text" data-answer="verkrijgMaanden()"> <span class="operator">+</span> <span class="string">'-'</span> <span class="operator">+</span> datum.<input id="3-1-3" type="text" data-answer="verkrijgVolledigJaar()">;</pre></code><br/>

		<input class="exercise" id="excercise3-1" type="submit" value="Run Function"/>
	</div>

	<?php echo "<a href='/exercise-2?userID=".$userID."&language=".$language."'>Ga naar de opdracht van Module 3</a>"?>
